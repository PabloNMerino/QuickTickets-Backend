export const lastReminderTemplate = (title: string, date: Date, quantity: number): string => {
...
<table width="100%" style="max-width: 600px; margin: auto; background-color: #2B293D; color: #FFFFFF;">
    <tr>
        <td style="text-align: center; padding: 20px;">
            <h1 style="color: #FFE047; margin-bottom: 5px;">¡Tu Evento es HOY!</h1>
            <p style="color: #FFFFFF; font-size: 16px;">QuickTickets te recuerda que hoy es tu evento!.</p>
        </td>
    </tr>
    <tr>
        <td style="padding: 20px;">
            ...
            <p style="color: #FFFFFF; font-size: 16px; line-height: 1.5;">
                Aquí tienes un recordatorio de los detalles de tu evento:
            </p>
